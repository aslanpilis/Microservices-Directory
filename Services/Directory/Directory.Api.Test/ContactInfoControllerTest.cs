...
namespace Directory.Api.Test
{
    public class ContactInfoControllerTest
    {
        ...
        {
            var okResult = await _contactInfoController.GetAllByUserId("1");


            var objok = okResult as ObjectResult;

            var validresponse = objok.Value as Response<List<ContactInfoDto>>;
            Assert.Equal(200, validresponse.StatusCode);
        ...
        public async void CreateTest()
        {
            ...
            var response = obj.Value as Response<ContactInfoDto>;
